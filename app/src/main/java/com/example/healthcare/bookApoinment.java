...
public class bookApoinment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_apoinment);
            ...
            ed3 = findViewById(R.id.appContactNumber);
            ed4 = findViewById(R.id.appFees);
            appBook = findViewById(R.id.appBookAppoinmentBtn);
            appBack = findViewById(R.id.appBackBtn);


            dateButton = findViewById(R.id.appBtnDate);
            timeButton = findViewById(R.id.appBtnTime);
        ...
        // timePicker
            ...
            appBook.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
